...
if jedenstrzal:
    ...
    generuj_pliki([0,1],do_tfa_morlet, morlet_log=True, subtract_mean=False, reduct_tfa_baseline = False, red_method=2)
    ...
    generuj_wynikowe(do_tfa_morlet)

    print("###########################################")
    print("Pomieszalem dane!")
    print("###########################################")
else:           #Hurtowe generowanie danych >100 GB!!
    generuj_pliki([0, 1, 2, 3, 4, 6, 7, 8], do_tfa_morlet, morlet_log=True, subtract_mean=False,
                  reduct_tfa_baseline=False, red_method=2)
    generuj_wynikowe(do_tfa_morlet)

    generuj_pliki([0, 1, 2, 3, 4, 6, 7, 8], do_tfa_morlet, morlet_log=True, subtract_mean=True,
                  reduct_tfa_baseline=False, red_method=2)
    generuj_wynikowe(do_tfa_morlet)
