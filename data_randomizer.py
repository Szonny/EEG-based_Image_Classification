...
def przemieszaj_dane(nicki_badanych, przyrostek_wynikowy):
    ...
    for it in range(0, len(nicki_badanych)):
        tablica = np.load(f"data/{nicki_badanych[it]}{obecny_typ_pliku}{czy_us_srednia}{obecna_metoda_red}.npy", allow_pickle=True)
    ...
    for nr_zrodla in range(0,len(nicki_badanych)):              #dla każdego zrodla
        zrodlo = np.load(f"data/{nicki_badanych[it]}{obecny_typ_pliku}{czy_us_srednia}{obecna_metoda_red}.npy", allow_pickle=True)
        etykiety = np.load(f"data/{nicki_badanych[nr_zrodla]}{obecny_typ_pliku_et}{czy_us_srednia}{obecna_metoda_red}.npy", allow_pickle=True)
    ...
    for nr_wynikowego in range(0, ilosc_wynikowych):
        ...
        np.save(f"data2/plikWynikowy{nr_wynikowego}_{przyrostek_wynikowy}{obecny_typ_pliku}{obecna_metoda_red}{czy_us_srednia}.npy", dane)
        np.save(f"data2/plikWynikowyET{nr_wynikowego}_{przyrostek_wynikowy}{obecny_typ_pliku}{obecna_metoda_red}{czy_us_srednia}.npy", et)
    ...
    if suma_dlugosci % (len(nicki_badanych)) > 0:
        ...
        dane = np.concatenate(dane, axis = 0)
        et = np.concatenate(et, axis = 0)
        np.save(f"data2/plikWynikowy{ilosc_wynikowych}_{przyrostek_wynikowy}{obecny_typ_pliku}{obecna_metoda_red}{czy_us_srednia}.npy",dane)
        np.save(f"data2/plikWynikowyET{ilosc_wynikowych}_{przyrostek_wynikowy}{obecny_typ_pliku}{obecna_metoda_red}{czy_us_srednia}.npy", et)

        #--------------------Sprawdzenie-----------------------------------------------

    dane = np.load(f"data/{nicki_badanych[it]}{obecny_typ_pliku}.npy", allow_pickle=True)
    etykiety = np.load(f"data/{nicki_badanych[it]}{obecny_typ_pliku_et}{czy_us_srednia}{obecna_metoda_red}.npy", allow_pickle=True)
    ...
    for nr_wynikowego in range(0, ilosc_wynikowych):
        dane = np.load(f"data2/plikWynikowy{nr_wynikowego}_{przyrostek_wynikowy}{obecny_typ_pliku}{czy_us_srednia}{obecna_metoda_red}.npy")
        etykiety = np.load(f"data2/plikWynikowyET{nr_wynikowego}_{przyrostek_wynikowy}{obecny_typ_pliku}{czy_us_srednia}{obecna_metoda_red}.npy")
    ...
    if (os.path.exists(f"data2/plikWynikowy{ilosc_wynikowych}_{przyrostek_wynikowy}{obecny_typ_pliku}") and
        ...
        dane = np.load(f"data2/plikWynikowy{ilosc_wynikowych}_{przyrostek_wynikowy}{obecny_typ_pliku}{czy_us_srednia}{obecna_metoda_red}.npy")
        etykiety = np.load(f"data2/plikWynikowyET{ilosc_wynikowych}_{przyrostek_wynikowy}{obecny_typ_pliku}{czy_us_srednia}{obecna_metoda_red}.npy")
    ...
    np.save(f"data2/paramerty_{przyrostek_wynikowy}{obecna_metoda_red}{czy_us_srednia}.npy", parametry)
...
def generuj_TRAIN():
    ...
    nicki_badanych = PRZYROSTKI_PLIKOW[0:5]
...
def generuj_wynikowe(do_TFA = True, metoda_red = 2, us_sre=False):
